...
<footer class="bg-dark text-white">
    <div class="container position-relative py-5">
        <img class="position-absolute top-50 end-0 translate-middle-y" style="z-index: 1;"
            src="{{ asset('images/dc-logo-bg.png') }}" alt="DC Logo Background" />
        <div class="row position-relative" style="z-index: 2;">
            <div class="col-md-4">
                <h5 class="fw-bold mb-3">DC COMICS</h5>
                <ul class="list-unstyled mb-4">
                    @foreach ($links as $link)
                        <li class="mb-2"><a href="{{ $link['url'] }}"
                                class="text-secondary text-decoration-none">{{ $link['text'] }}</a></li>
                    @endforeach
                </ul>
    ...
    <div class="bg-secondary-dark py-4 z-10">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end"> <span class="text-primary me-3">FOLLOW US</span>
                    ...
                    <a href="#" class="ms-3"><img src="{{ asset('images/footer-pinterest.png') }}"
                            alt="Pinterest" /></a>
                    <a href="#" class="ms-3"><img src="{{ asset('images/footer-periscope.png') }}"
                            alt="Periscope" /></a>
                </div>
            </div>
        </div>
